...
<body>
    ...
    <?php
        ...
        // echo str_replace("diam", "BANANAAAA", $str) . "<br>";
        // echo str_replace("w", "z", $str);

        function replaceString($string) {
            echo str_replace("diam", "BANANAAAA", $string) . "<br>";
            echo str_replace("w", "z", $string);
        }
        
        replaceString($str);
    ?>

<!-- Question 3 : str_replace :  
s
try to change in the precedent text the word diam/DIAM by “BANANAAAA”;
try to change every “e” by “z”; -->
