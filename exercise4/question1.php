...
<body>
    ...
    <?php
        ...
        // echo "There are 5 paragraphs " . strlen($str) . " words, " . str_word_count($str) . " characters generated.";

        // How can I make this generic
        function findLength($string) {
            echo "There are 5 paragraphs " . strlen($string) . " characters, " . str_word_count($string) . " words  generated.";
        }

        findLength($str);
    ?>

<!-- 5 paragraphs, 500 words, 3337 characters generated -->
</body>
</html>